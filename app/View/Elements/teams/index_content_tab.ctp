<section class="content">
	<div class="box box-primary">
		<div class="box-header with-border">
			...
			<?php echo $this->Html->link('<i class="fa fa-plus-square"></i> เพิ่มข้อมูล', '/teams/add', array('class' => 'btn btn-success', 'escape' => false)) ?>
			<div class="box-tools">
		...
		<div class="box-body" id="team-container">
			<?php echo $this->element('teams/index_content_table'); ?>
		</div>
	</div>
</section>
